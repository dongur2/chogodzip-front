...
export default {
  ...
  selectOneInModalAndSearch (showDropdown, searchQuery, result,
                              map, propertiesData, filteredProperties, heartIcons, markers, filters, fetchDataFunction) {
    searchQuery.value = result.name;
    showDropdown.value = false; // 드롭다운 닫기

    this.searchDataNearByUniversity(map, searchQuery, propertiesData, filteredProperties, heartIcons, markers, filters, fetchDataFunction);
  },
  ...
  async searchDataNearByUniversity (map, searchQuery, propertiesData, filteredProperties, heartIcons, markers, filters, fetchDataFunction) {
